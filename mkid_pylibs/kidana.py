...
class KidAnalyzer(object):
    ...
    def fitIQ(self, **kws):
        ...
        if self._cont_swpdata is not None:
            ...
            self._swpdata.mdata = KidGlobalResponse('I-Q',(miq.real,miq.imag))
