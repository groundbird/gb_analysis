...
#    if len(klist.kids_power) == 1:
    for i,phase in enumerate(phase_list):
        cos = klist.tone_amps[i] * cosf(t, rf_freqlist[i], 1, phase)/num_tone
        rf_cos_mix += cos
...
if __name__ == '__main__':
    ...
    phase_list = scipy.optimize.fmin_bfgs(f=cal_cre, x0=phase_list, args=(klist, ))
    ...
    crest_factor = cal_cre(phase_list, klist)
    print('crest factor')
    print(crest_factor)
